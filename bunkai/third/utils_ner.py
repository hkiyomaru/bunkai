...
class InputExample:
    ...
    :param words: list. The words of the sequence.
    :param labels: (Optional) list. The labels for each word of the sequence. This should be
    :param specified for train and dev examples, but not for test examples.
    :param is_document_first: First fragment of document.
    """

    guid: str
    words: List[str]
    labels: Optional[List[str]]
    is_document_first: bool
...
def convert_examples_to_features(
    ...
    :param cls_token_segment_id: define the segment id associated to the CLS token (0 for BERT, 2 for XLNet)
    """
    # TODO clean up all this to leverage built-in features of tokenizers
